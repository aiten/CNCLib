namespace CNCLib.GUI.Load
{
    partial class LoadOptionForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this._loadHTML = new System.Windows.Forms.RadioButton();
			...
			this._loadHTML.TabIndex = 39;
			this._loadHTML.Text = "Load HTML";
			this._loadHTML.UseVisualStyleBackColor = true;
			// 
			// _loadImage
			// 
		...
		private System.Windows.Forms.RadioButton _loadHTML;
