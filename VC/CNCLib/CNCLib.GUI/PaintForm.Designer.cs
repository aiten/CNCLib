namespace CNCLib.GUI
{
    partial class PaintForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this._plotterCtrl = new CNCLib.GUI.GCodeUserControl();
            ...
            0,
            0});
			this._plotterCtrl.GCodeMousePosition += new CNCLib.GUI.GCodeUserControl.GCodeEventHandler(this._plotterCtrl_GCodeMousePosition);
			// 
			// PaintForm
			// 
