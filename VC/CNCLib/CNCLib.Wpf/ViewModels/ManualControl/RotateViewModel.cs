...
namespace CNCLib.Wpf.ViewModels.ManualControl
{
	public class RotateViewModel : DetailViewModel
	{
		...
		public void SendG69()							{ RunInNewTask(() => { Com.SendCommand("g69"); }); }
		public void SendG68X0Y0R90()					{ RunInNewTask(() => { Com.SendCommand("g68 x0y0r90"); }); }
		public void SendG68X0Y0R270()                   { RunInNewTask(() => { Com.SendCommand("g68 x0y0r270"); }); }
		public void SendG6810()							{ RunInNewTask(() => { Com.SendCommand("g68.10"); }); }
		public void SendG6811()							{ RunInNewTask(() => { Com.SendCommand("g68.11"); }); }
		public void SendG6813()							{ RunInNewTask(() => { Com.SendCommand("g68.13 j0k0"); }); }
		public void SendG6814()							{ RunInNewTask(() => { Com.SendCommand("g68.14 i0"); }); }
