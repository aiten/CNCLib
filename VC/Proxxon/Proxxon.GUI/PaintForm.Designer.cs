namespace Proxxon.GUI
{
    partial class PaintForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this._plotterCtrl = new Proxxon.GUI.GCodeUserControl();
            ...
            0,
            0});
			this._plotterCtrl.GCodeMousePosition += new Proxxon.GUI.GCodeUserControl.GCodeEventHandler(this._plotterCtrl_GCodeMousePosition);
			// 
			// PaintForm
			// 
