...
#else
	super::GoToReference(axis, CMotionControlBase::FeedRateToStepRate(axis,1000000), toMinRef);
	super::GoToReference(axis, CMotionControlBase::FeedRateToStepRate(axis, 200000), toMinRef);
#endif
}
