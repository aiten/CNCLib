...
unsigned long CU8GLcd::DrawLoop()
{
	...
	if (_curretDraw)
	{
		...
		(this->*_curretDraw)(DrawLoopQueryTimerout,(intptr_t) &timeout);
	}
	return timeout;
}
...
bool CU8GLcd::DrawLoopDefault(EnumAsByte(EDrawLoopType) type, intptr_t /* data */)
{
	switch (type)
	{
		case DrawLoopSetup:
...
bool CU8GLcd::DrawLoopSplash(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
...
bool CU8GLcd::DrawLoopDebug(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
...
bool CU8GLcd::DrawLoopPosAbs(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type==DrawLoopHeader)	return true;
	if (type!=DrawLoopDraw)		return DrawLoopDefault(type,data);
...
bool CU8GLcd::DrawLoopPos(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type == DrawLoopHeader)	return true;
	if (type != DrawLoopDraw)	return DrawLoopDefault(type, data);
...
bool CU8GLcd::DrawLoopRotate2D(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type == DrawLoopHeader)	return true;
	if (type==DrawLoopQueryTimerout)	{ *((unsigned long*)data) = 200000; return true; }
	if (type != DrawLoopDraw)	return DrawLoopDefault(type, data);
...
bool CU8GLcd::DrawLoopRotate3D(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type == DrawLoopHeader)	return true;
	if (type==DrawLoopQueryTimerout)	{ *((unsigned long*)data) = 200000; return true; }
	if (type != DrawLoopDraw)		return DrawLoopDefault(type, data);
...
bool CU8GLcd::DrawLoopSpeedOverride(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type == DrawLoopHeader)			return true;
...
bool CU8GLcd::DrawLoopPreset(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type==DrawLoopHeader)			return true;
	if (type==DrawLoopQueryTimerout)	{ *((unsigned long*)data) = 200000; return true; }
	if (type!=DrawLoopDraw)				return DrawLoopDefault(type,data);
...
bool CU8GLcd::DrawLoopStartSD(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type!=DrawLoopDraw)		return DrawLoopDefault(type,data);
...
bool CU8GLcd::DrawLoopError(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type!=DrawLoopDraw)		return DrawLoopDefault(type,data);
	if (type==DrawLoopQueryTimerout)	{ *((unsigned long*)data) = 5000; return true; }
...
bool CU8GLcd::DrawLoopCommandHis(EnumAsByte(EDrawLoopType) type,intptr_t data)
{
	if (type==DrawLoopQueryTimerout)	{ *((unsigned long*)data) = 5000; return true; }
	if (type!=DrawLoopDraw)		return DrawLoopDefault(type,data);
...
bool CU8GLcd::DrawLoopMenu(EnumAsByte(EDrawLoopType) type, intptr_t data)
{
	if (type==DrawLoopHeader)			return true;
