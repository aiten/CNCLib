...
#pragma warning( disable : 4127 )
	...
	WRITE(RAMPSFD_X_DIR_PIN, RAMPSFD_PINON);
	WRITE(RAMPSFD_Y_DIR_PIN, RAMPSFD_PINON);
	WRITE(RAMPSFD_Z_DIR_PIN, RAMPSFD_PINON);
	WRITE(RAMPSFD_E0_DIR_PIN, RAMPSFD_PINON);
	WRITE(RAMPSFD_E1_DIR_PIN, RAMPSFD_PINON);
	WRITE(RAMPSFD_E2_DIR_PIN, RAMPSFD_PINON);
...
#pragma warning( default : 4127 )
	...
	pinMode(RAMPSFD_D2,  OUTPUT); WRITE(RAMPSFD_D2,0);
	pinMode(RAMPSFD_D12, OUTPUT); WRITE(RAMPSFD_D12,0);
