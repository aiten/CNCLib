...
#define Y_REFERENCEHITVALUE_MIN HIGH
#define Z_REFERENCEHITVALUE_MIN HIGH
#define A_REFERENCEHITVALUE_MIN HIGH
#define B_REFERENCEHITVALUE_MIN HIGH
#define C_REFERENCEHITVALUE_MIN HIGH

#define X_REFERENCEHITVALUE_MAX HIGH
#define Y_REFERENCEHITVALUE_MAX HIGH
#define Z_REFERENCEHITVALUE_MAX HIGH
#define A_REFERENCEHITVALUE_MAX HIGH
#define B_REFERENCEHITVALUE_MAX HIGH
#define C_REFERENCEHITVALUE_MAX HIGH
