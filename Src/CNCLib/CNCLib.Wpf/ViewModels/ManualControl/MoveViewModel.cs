...
namespace CNCLib.Wpf.ViewModels.ManualControl
{
	public class MoveViewModel : DetailViewModel
	{
        ...
        private void SendMoveCommand(double? dist, char axisname) { RunAndUpdate(() => { Global.Instance.Com.QueueCommand(MachineGCodeHelper.PrepareCommand("g91 g0" + axisname + (dist??0.0).ToString(CultureInfo.InvariantCulture) + " g90")); }); }
