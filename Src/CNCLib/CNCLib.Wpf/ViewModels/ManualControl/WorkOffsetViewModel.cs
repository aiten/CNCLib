...
namespace CNCLib.Wpf.ViewModels.ManualControl
{
	public class WorkOffsetViewModel : DetailViewModel
	{
        ...
        public void SendG53() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g53"); }); }
		public void SendG54() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g54"); }); }
		public void SendG55() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g55"); }); }
		public void SendG56() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g56"); }); }
		public void SendG57() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g57"); }); }
		public void SendG58() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g58"); }); }
		public void SendG59() { RunAndUpdate(() => { Global.Instance.Com.Current.QueueCommand("g59"); }); }
