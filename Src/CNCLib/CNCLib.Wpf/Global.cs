...
namespace CNCLib.Wpf
{
	public class Global : Singleton<Global>, INotifyPropertyChanged
	{
		...
		public Joystick Joystick { get => _joystick;  set { _joystick = value; RaisePropertyChanged(); } }


        private decimal _sizeX = 140m;
        public decimal SizeX { get => _sizeX; set { _sizeX = value; RaisePropertyChanged(); } }

        private decimal _sizeY = 45m;
        public decimal SizeY { get => _sizeY; set { _sizeY = value; RaisePropertyChanged(); } }

        private decimal _sizeZ = 80m;
        public decimal SizeZ { get => _sizeZ; set { _sizeZ = value; RaisePropertyChanged(); } }
