    ...
    public class CNCLibDefaultData
    {
        ...
        private void ItemSeed(CNCLibContext context)
        {
            ...
            var itemproperties = new[]
            {
                ...
                new ItemProperty
                {
                    Item  = graveIMGG00G01Item,
                    Name  = @"SettingName",
                    Value = graveIMGG00G01Item.Name
                },
